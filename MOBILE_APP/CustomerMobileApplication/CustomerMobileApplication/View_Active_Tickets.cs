...
{
    [Activity(Label = "Active Tickets")]
    public class View_Active_Tickets : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.View_Active_Tickets);
            Passenger thisPassenger = JsonConvert.DeserializeObject<Passenger>(Intent.GetStringExtra("Passenger"));

            // Adds items to listView
            ListView listActiveTickets = FindViewById<ListView>(Resource.Id.listView_activeTickets);
            ...
            listActiveTickets.Adapter = listAdapter;
            ...
            refresh.Click += async delegate
            {
                ...
                foreach (Ticket lp in parsedJSON)
                {
                    if (lp.PASSENGER_ID == thisPassenger.ID)
                    {
                        ...
                        listActiveTickets.Adapter = newListAdapter;
                    }
                }
            };

            // Create method for click event
            listActiveTickets.ItemClick += listActiveTickets_ItemClick;
        ...
        private void listActiveTickets_ItemClick(object sender, ItemClickEventArgs e)
        {
            //throw new NotImplementedException();

            ListView selectedList = FindViewById<ListView>(Resource.Id.listView_activeTickets);
            ...
            for (int i = 0; i < myStrings.Count(); i++)
            {
                ...
                if (selectedItemNum == userId)
                {
                    ...
                    var dialogView = LayoutInflater.Inflate(Resource.Layout.Active_Ticket, null);
                    ...
                    var items = new string[] { "Date: " + date, "Ticket ID: " + ticketId, "Booking Type: " + bookingType, "Seat Number: " + seatNumber, "Depart Time: " + depTime, "Depart Station: " + depStation, "Depart Platform: " + departPlatform,"Arrival Time: " + arrivalTime, "Arrival Station: " + arrivalStation, "Arrival Platform: " + arrivalPlatform };
                    var adapter = new ArrayAdapter<string>(this, Android.Resource.Layout.SimpleListItem1, items);
                    dialogView.FindViewById<ListView>(Resource.Id.listView_viewTicket).Adapter = adapter;
                    alertDialog.Show();
                }
            }
